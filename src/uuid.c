...
#if __STDC_VERSION__ >= 201112L
static void atomic_compare_and_zero(uint64_t v1, _Atomic uint64_t *v2, _Atomic uint64_t *v)
#else
static void atomic_compare_and_zero(uint64_t v1, uint64_t *v2, uint64_t *v)
#endif
{
	if (v1 != *v2)
	{
