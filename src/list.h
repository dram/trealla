...
#define LIST_REPLACE(l,n,m) list_replace(l,&(n)->hdr,&(m)->hdr)
...
extern void list_replace(list *l, const lnode *n, lnode *m);
extern lnode *list_remove(list *l, const lnode *n);
