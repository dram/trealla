...
extern void sb_find(const skipbuck *s, const void *key, int (*callback)(void *p1,const void *key,const void *value), void *p1);
...
#define sb_string_create2() sb_create2((int (*)(const void*, const void*))&strcmp, (void *(*)(const void*))&strdup, &free, (void *(*)(const void*))&strdup, &free)
...
#define sb_int_uuid_find(s,k,f,a) sb_find(s, (const void*)(size_t)k, (int (*)(void*,const void*,const void*))f, (void*)a)
