...
#ifndef ISO_ONLY
#define UTF8LEN_S(n) (is_blob(n) ? (n)->val_len : strlen_utf8(VAL_S(n)))
#define LEN_S(n) (is_blob(n) ? (n)->val_len : strlen(VAL_S(n)))
#else
#define UTF8LEN_S(n) strlen_utf8(VAL_S(n))
...
#define TERM_PRINT(term) term_print(q->pl, q, term, 0)
