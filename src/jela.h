...
extern void try_me2(tpl_query *q, int nofollow, int nochoice, int transparent, int catchme);

#define try_me(q) try_me2(q, 0, 0, 0, 0)
#define try_me_catch(q) try_me2(q, 0, 0, 0, 1)
#define try_me_nofollow(q) try_me2(q, 1, 0, 0, 0)
#define try_me_nochoice(q) try_me2(q, 0, 1, 0, 0)
#define try_me_transparent(q) try_me2(q, 0, 1, 1, 0)
