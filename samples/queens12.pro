% Find all solutions of an 12 by 12 board.
% The \+ with the fail is a trick to make it find all solutions.

% There should be 14200 solutions:
%
%      ./tpl samples/queens12 -q --test | wc -l

test :- queens(12, Qs), write(Qs), nl, fail.
test.

testq :- queens(12, Qs), fail.
testq.
