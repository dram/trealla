...
test11b :-
	write('Test11b:\t'),
	findall(X,xmember(X,[one,two,three]),L),
	L = [one,two,three],
	write('PASSED!'), nl, !.
...
test1812(X) :- X = f(a,b), fail.
test1812(X) :- X = f(b,c), fail.
test1812(X) :- X = f(_,world).
test181(X) :- test1812(X).

test1822(X) :- X = f(e,f), fail.
test1822(X) :- X = f(f,g), fail.
test1822(X) :- X = f(hello,_).
test182(X) :- test1822(X).
